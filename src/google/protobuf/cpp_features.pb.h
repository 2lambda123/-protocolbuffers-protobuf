...
constexpr CppFeatures_StringType CppFeatures_StringType_StringType_MAX = static_cast<CppFeatures_StringType>(4);
constexpr int CppFeatures_StringType_StringType_ARRAYSIZE = 4 + 1;
...
/* @@protoc_insertion_point(class_definition:pb.CppFeatures) */ {
 ...
 public:
  ...
  static constexpr StringType UNDEFINED = CppFeatures_StringType_UNDEFINED;
  ...
  static constexpr StringType STRING_PIECE = CppFeatures_StringType_STRING_PIECE;
